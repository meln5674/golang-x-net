...
func newHybiConn(config *Config, buf *bufio.ReadWriter, rwc io.ReadWriteCloser, request *http.Request) *Conn {
	...
	ws := &Conn{
		config: config, request: request, buf: buf, rwc: rwc,
...
func hybiClientHandshake(config *Config, br *bufio.Reader, bw *bufio.Writer) (err error) {
	_, err = hybiClientHandshakeOrResponse(config, br, bw)
	return err
}

// Client handshake described in draft-ietf-hybi-thewebsocket-protocol-17
func hybiClientHandshakeOrResponse(config *Config, br *bufio.Reader, bw *bufio.Writer) (resp *http.Response, err error) {
